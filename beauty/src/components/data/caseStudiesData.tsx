...
export const caseStudies: CaseStudy[] = [
  {
    ...
    icon: <Lock size={20} />,
    images: [
      { url: "/images/security/cameraOnFence.jpeg", caption: "Outdoor IP Surveillance Camera Installation with Perimeter Security Monitoring." },
      ...
      { url: "/images/security/door control access.jpeg", caption: "Multi-Modal Facial Recognition Access Control for Corporate Offices." },
      { url: "/images/security/solarPoweredInfraRedSecuriityCamera.jpeg", caption: "Integrated dashboard for real-time traffic logs." }
    ]
  },
  {
    sector: "Solar", 
    title: "Solar System Installation and Maintenance for Commercial and Residential use.",
    ...
    images: [
      ...
      { url: "/images/solar/solar system installation.jpeg", caption: "1.5kW Hybrid Solar Power System with 200AH GEL Backup Batteries - Namugongo." },
      ...
      { url: "/images/solar/solar hospital.jpeg", caption: "Healthcare-Grade Solar Power Grid Installation for Hospital Backup." },
  ...
  },
  {
    ...
    icon: <Zap size={20} />, 
    images: [
      { url: "/images/power/Electrical maintenance.jpeg", caption: "Electrical Inspection and Maintenance for Commercial Facilities." },
      ...
      { url: "/images/power/industrial installation.jpeg", caption: "11KV High-Voltage Industrial Substation Installation in Hoima, Uganda." },
